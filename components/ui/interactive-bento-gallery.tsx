    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed inset-0 w-full min-h-screen bg-black/95 backdrop-blur-xl overflow-hidden z-[100] flex items-center justify-center p-4 sm:p-6 md:p-8"
            >
                {/* Main Content */}
                <div className="relative w-full max-w-5xl max-h-[80vh] flex flex-col items-center justify-center">
                    <AnimatePresence mode="wait">
                        <motion.div
                            key={selectedItem.id}
                            className="relative max-w-full max-h-[70vh] rounded-lg overflow-hidden shadow-2xl flex flex-col items-center justify-center"
                        ...
                        >
                            {selectedItem.type === 'video' ? (
                                <video
                                    className="max-w-full max-h-[60vh] object-contain rounded-lg shadow-inner bg-black/40"
                                    onClick={onClose}
                                    playsInline
                                    muted
                                    loop
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 via-black/40 to-transparent text-left">
                ...
                {/* Close Button */}
                <motion.button
                    className="absolute top-4 right-4 p-3 rounded-full bg-rose-500 text-white hover:bg-rose-600 transition-colors shadow-lg z-[120]"
                    onClick={onClose}
